...
#LoadingImages
skyImg = pygame.image.load("C:/Python31/background.jpg")
skyImg = pygame.transform.scale(skyImg, (display_width, display_height))
playerImg = pygame.image.load("C:/Python31/cute_man.png")
playerImg = pygame.transform.scale(playerImg, (80, 80))
stoneImg = pygame.image.load("C:/Python31/stone.png")
stoneImg = pygame.transform.scale(stoneImg, (50, 50))
stone2Img = pygame.image.load("C:/Python31/stone.png")
stone2Img = pygame.transform.scale(stoneImg, (75, 75))
coinImg = pygame.image.load("C:/Python31/coin.png")
